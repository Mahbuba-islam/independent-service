...
const Blogs = () => {
    return (
        <div className='ms-5   ' >
            <h2 className='text-primary text-center'>Authentication vs. authorization</h2>
     <div>
         <div className='py-3 px-1 w-25%'>
         <h3 className='text-primary text-center'>Authentication</h3>
          <p className='text-center text-black  '>Authentication is the process of determining the users identity via the available credentials, thus verifying the identity. Some ways to authenticate one's identity are listed here:
...
<div>
    ...
    <p className='text-center text-black'>Authentication options 1 Authentication application. ... 2 Security key. ... 3 PIV or CAC for federal government employees and military. ... 4 Text message / Phone call. ... 5 Backup codes Backup codes are an accessible option for users who do not have access to a phone.</p>
</div>
<div>
    <h3 className='text-primary text-center'>What other services does firebase provide other than authentication?</h3>
    <p className='text-center text-black'>Most apps need to know the identity of a user. Knowing a user's identity allows an app to securely save user data in the cloud and provide the same personalized experience across all of the user's devices. Firebase Authentication provides backend services, easy-to-use SDKs, and ready-made UI libraries to authenticate users to your app.</p>
</div>
</div>
